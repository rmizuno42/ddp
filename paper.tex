...
AI/LLMs in mathematical discovery {[}Bubeck2025, Woodruff2026,
...
reproduced directly, as described in §A.8 of Appendix A.
...
\subsection{2.2 Recorded lower bounds and the improvement in this
...
\textbf{Theorem 2.1.} There exist explicit connected simple undirected graphs
...
\textbf{Proposition 2.2 (route-chart lift principle).} Let \(q\) be a prime
...
voltage-lift point of view (§A.2). In an ordinary voltage lift, one attaches a
...
explanations of the prospects of success in advance (§4, §5).
...
group {[}GrossTucker2001{]}. In the degree/diameter problem, the
...
bundled edge-list generator. The proof of Lemma A.8, however, only needs
...
pair--voltage combinations of condition (A.0). \(\square\)
...
\textbf{Proof.} Fix the \(144\)-vertex controller \(C\) of §A.5 and an
...
\item
  ...
  voltage assignment on the base multigraph, given in Table A.1,
  together with the universal route chart on \(\mathbb F_q^5\) defined
  in §A.6, namely the transition matrices \(A_t\) and vectors \(b_t\).
...
\NormalTok{GF(3)\^{}5 universal chart: OK; 324 reduced words checked, min rank 5; inverse{-}symbol data verified}
\NormalTok{Certificate complete: degree 12, diameter \textless{}=5, vertices = 144*3\^{}5 = 34992}
\end{Highlighting}
\end{Shaded}
...
\item
  ...
  Details are given in §A.8 of Appendix A.
\item
  ...
  executed by verifiers. Details are given in §A.8 of Appendix A.
\item
...
\emph{Journal of the Faculty of Science, University of Tokyo, Section
IA, Mathematics} 20 (1973), 191--208.
...
assignment approach. \emph{Australasian Journal of Combinatorics} 18
(1998), 65--76.
...
{[}Comellas2025{]} F. Comellas. New results on the degree-diameter
problem for undirected graphs. \emph{Electronic Journal of Graph Theory
and Applications} 13(1) (2025), 211--215. DOI:
10.5614/ejgta.2025.13.1.14.

{[}Comellas2026{]} F. Comellas. Table of large graphs with given degree
and diameter. arXiv:2406.18994v2, 2026. DOI:
10.48550/arXiv.2406.18994.
...
Spectra and eigenspaces of arbitrary lifts of graphs. \emph{Journal of
Algebraic Combinatorics} 54 (2021), 651--672. DOI:
10.1007/s10801-021-01049-3.

{[}Damerell1973{]} R. M. Damerell. On Moore graphs. \emph{Mathematical
...
{[}Petersen1891{]} J. Petersen. Die Theorie der regulären Graphs.
\emph{Acta Mathematica} 15 (1891), 193--220.
